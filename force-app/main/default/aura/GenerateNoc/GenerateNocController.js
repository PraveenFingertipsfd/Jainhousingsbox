({
    doInit : function(component, event, helper) {
        ...
        action.setCallback(this,function(a){           
            ...
            let url;
            if(bookingval.Bank__c == 'SBI'){
                url = baseUrl+'/apex/SBI_BUILDER_NOC?Id='+component.get("v.recordId");
            }else if(bookingval.Bank__c == 'HDFC'){
                url = baseUrl+'/apex/HDFC_NOC?Id='+component.get("v.recordId");
            }else if(bookingval.Bank__c == '' ||bookingval.Bank__c == null){
      ...
      send: function(component, event, helper) {
        // Call the Apex method 'sendEmailGenerateNOC'
        var action = component.get("c.sendEmailGenerateNOC");
