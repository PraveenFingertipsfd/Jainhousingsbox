({
    ...
    let url = baseUrl + '/apex/PossessionLetter?Id=' + recordId;
    component.set("v.vfPageUrl", url);
},
     send: function(component, event, helper) {
        // Call the Apex method 'sendEmailGeneratePossessionLetter'
        var action = component.get("c.sendEmailGeneratePossessionLetter");
