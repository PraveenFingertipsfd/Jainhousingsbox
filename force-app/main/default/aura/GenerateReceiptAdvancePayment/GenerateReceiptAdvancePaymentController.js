({
    doInit : function(component, event, helper) {
       ...
       // action.setCallback(this,function(a){           
           ...
           // if(bookingval.Project_Company__c == 'MAHENDRA HOMES PVT LTD'){
                url = baseUrl+'/apex/ERP_AdvancePayment?Id='+component.get("v.recordId");
           // }else if(bookingval.Project_Company__c == 'MAHENDRA ARTO LLP'){
                //url = baseUrl+'/apex/RECEIPT_HELIX?Id='+component.get("v.recordId");
           // }
    ...
    send: function(component, event, helper) {
        ...
        var action = component.get("c.sendEmailGenerateAdvancePaymentReceipt");
