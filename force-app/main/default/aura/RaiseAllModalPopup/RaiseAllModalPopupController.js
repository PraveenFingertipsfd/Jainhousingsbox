    ...
    submit: function(component, event, helper) {
        ...
        checkboxes.forEach(function(checkbox) {
            if (checkbox.get("v.checked")) { 
                ...
                var milestoneName = checkbox.get("v.name");
                ...
                let ProjectName = '';
                if (bookingRecord.Project1__r.Name) {
                    ProjectName = bookingRecord.Project1__r.Name;
                }
                ...
                console.log('selectedRecords'+ JSON.stringify(defaultEmailContent));
