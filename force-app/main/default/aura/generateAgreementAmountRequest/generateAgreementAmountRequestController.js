({
    doInit : function(component, event, helper) {
        ...
        action.setCallback(this,function(a){           
            ...
            let url;
            if(bookingval.Project__c == 'Aarya'){
                url = baseUrl+'/apex/AGREEMENT_AMOUNT_REQUEST_AARYA?Id='+component.get("v.recordId");
            }else if(bookingval.Project__c == 'Arto Helix'){
                url = baseUrl+'/apex/AGREEMENT_AMOUNT_REQUEST_HELIX?Id='+component.get("v.recordId");
            }
     ...
     send: function(component, event, helper) {
        // Call the Apex method 'sendEmailGenerateAAR'
        var action = component.get("c.sendEmailGenerateAAR");
