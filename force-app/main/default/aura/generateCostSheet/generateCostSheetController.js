    ...
    doInit : function(component, event, helper) {
        ...
        action.setCallback(this,function(a){           
            ...
            if(bookingval.Project_Company__c == 'MAHENDRA HOMES PVT LTD'){
                url = baseUrl+'/apex/COST_SHEET_AARYA?Id='+component.get("v.recordId");
            }else if(bookingval.Project_Company__c == 'MAHENDRA ARTO LLP'){
                url = baseUrl+'/apex/COST_SHEET_HELIX?Id='+component.get("v.recordId");
            }
      ...
      send: function(component, event, helper) {
        // Call the Apex method 'sendEmailGenerateCostSheet'
        var action = component.get("c.sendEmailGenerateCostSheet");
