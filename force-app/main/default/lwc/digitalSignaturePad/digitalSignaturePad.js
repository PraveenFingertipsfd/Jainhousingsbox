...
export default class DigitalSignaturePad extends LightningElement {
...
@api
isSigned() {
return this.drawingSections && this.drawingSections.length > 0;
}

// Get base64-encoded signature image
@api
getSignatureData() {
return this.getSignature(true, true); // padColor=true, onlyInkedArea=true
}
